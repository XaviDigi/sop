            ...
            <Card className="w-full max-w-md">
                <CardHeader className="space-y-1 text-center">
                    <div className="flex justify-center mb-4">
                        <div className="flex items-center justify-center w-12 h-12 bg-primary text-primary-foreground rounded-md">
                            <span className="font-bold text-xl">SOP</span>
                        </div>
                    </div>
                    <CardTitle className="text-2xl font-bold">Sign in to SOP Manager</CardTitle>
                    <CardDescription>
